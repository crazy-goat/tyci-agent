...
// Legacy iteration-cap behavior is intentionally no longer exercised here:
// subagent jobs are unlimited. Top-level agent.Run cap behavior remains covered
// by agent/maxiter_test.go.
