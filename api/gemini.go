...
// GeminiStreamer streams a request against the Gemini generateContent
// protocol. The zero value is usable and behaves exactly like the old
// package-level StreamGemini function.
...
func (s GeminiStreamer) Stream(ctx context.Context, apiKey, endpoint string, body GeminiRequest, emit func(stream.Event) error) error {
